...
import Table from "@/app/components/forms/Table";
        ...
        <div className="flex flex-col p-8 gap-4">
            <div className="flex flex-col gap-4">
                ...
                <div className="flex gap-2">
                    ...
                    <div className="flex justify-between items-center rounded-lg outline-none bg-white border border-[#EEEEEE] px-[10px] py-3 gap-2">
                        <Image
                            src={Add}
                            width="16"
                            height="16"
