    ...
    return (
        <div className="items-center w-full grid grid-cols-2 gap-4 pt-4 text-sm realtive">
            ...
            <div className="flex w-full text-sm font-normal">
                ...
                />
                <button onClick={() => setAddServerModalOpen(true)} className="ml-2 flex justify-between w-fit items-center rounded-lg outline-none bg-white border border-[#EEEEEE] px-[10px] py-3">
                    <Image
                        src={Add}
                        width="16"
                        height="16"
