    ...
    return (
        <div className="flex w-full text-sm font-normal">
            <div className="flex w-full rounded-lg border border-cgrey-200 px-4 py-[10px] bg-[#141518]">
                <input type="text" placeholder={placeholder} className="outline-none appearance-none bg-transparent w-full placeholder:text-[#939393] text-white" />
                <div className="flex gap-2 w-fit justify-between items-center  text-white">
                    <Image
                        src={endContentImg}
                        width="16"
                        height="16"
