...
const CreateGiveaway: React.FC = () => {
    ...
    const [expiresDate, setExpiresDate] = useState<any>("2024-01-01");
            ...
            <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-3 text-[#FFFFFF]">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <input type="datetime-local" placeholder="31/05/2024" onChange={(e) => setExpiresDate(e.target.value)} value={expiresDate} className="text-[#FFFFFF] text-sm font-medium outline-none placeholder:text-sm placeholder:font-medium placeholder:text-[#FFFFFF] px-3 py-[10px] border border-cgrey-200 bg-[#141518] rounded-md" />
